...
# define MENU_LOAD_ROM     8
# define MENU_LOAD_DISK    9
...
psp_menu_display_save_name()
{
  ...
  snprintf(buffer, 30, "Game: %s", MO5.mo5_save_name);
...
psp_display_screen_menu(void)
{
  ...
  if (MO5.mo5_save_state[cur_slot].thumb) {
    psp_sdl_blit_thumb(140, 60, MO5.mo5_save_state[cur_slot].surface);
  #ifndef MIYOO_MODE
  } else {
    psp_sdl_blit_thumb(140, 60, thumb_surface);
  #endif
  }
...
psp_main_menu_hard_reset(void)
{
  ...
  psp_sdl_back2_print( 90, 175, "Hard Reset MO5 !", PSP_MENU_WARNING_COLOR);
  psp_sdl_flip();
  psp_mo5_hard_reset();
  reset_save_name();
  sleep(1);
...
psp_main_menu_soft_reset(void)
{
  /* Reset ! */
  psp_display_screen_menu();
  psp_sdl_back2_print( 90, 175, "Soft Reset MO5 !", PSP_MENU_WARNING_COLOR);
  psp_sdl_flip();
  psp_mo5_soft_reset();
  sleep(1);
}
...
psp_main_menu_load(int format)
{
  ...
  {
    psp_display_screen_menu();
    psp_sdl_back2_print( 90, 175, "File loaded !", 
                       PSP_MENU_NOTE_COLOR);
    psp_sdl_flip();
    sleep(1);
    return 1;
  ...
  {
    psp_display_screen_menu();
    psp_sdl_back2_print( 90, 175, "Can't load file !", 
...
psp_main_menu_load_slot()
{
  ...
  if (! MO5.mo5_save_state[cur_slot].used) {
    ...
    psp_display_screen_menu();
    psp_sdl_back2_print( 90, 175, "Slot is empty !", 
                       PSP_MENU_NOTE_COLOR);
    psp_sdl_flip();
    sleep(1);
...
psp_main_menu_save_slot()
{
  ...
  {
    psp_display_screen_menu();
    psp_sdl_back2_print( 90, 175, "File saved !", 
                       PSP_MENU_NOTE_COLOR);
    psp_sdl_flip();
    sleep(1);
  }
  ...
  {
    psp_display_screen_menu();
    psp_sdl_back2_print( 90, 175, "Can't save file !", 
                       PSP_MENU_WARNING_COLOR);
    psp_sdl_flip();
    sleep(1);
  }
...
psp_main_menu_del_slot()
{
  ...
  {
    psp_display_screen_menu();
    psp_sdl_back2_print( 90, 175, "File deleted !", 
                       PSP_MENU_NOTE_COLOR);
    psp_sdl_flip();
    sleep(1);
  }
  ...
  {
    psp_display_screen_menu();
    psp_sdl_back2_print( 90, 175, "Can't delete file !", 
                       PSP_MENU_WARNING_COLOR);
    psp_sdl_flip();
    sleep(1);
  }
...
psp_main_menu_rewind_k7()
{
  ...
  psp_display_screen_menu();
  psp_sdl_back2_print( 90, 175, "K7 rewinded !", 
                     PSP_MENU_NOTE_COLOR);
  psp_sdl_flip();
  sleep(1);
}
...
psp_main_menu_exit(void)
{
  ...
  psp_display_screen_menu();
  #ifdef MIYOO_MODE
  psp_sdl_back2_print( 90, 175, "press B to confirm !", PSP_MENU_WARNING_COLOR);
  #else
  psp_sdl_back2_print( 90, 175, "press X to confirm !", PSP_MENU_WARNING_COLOR);
  #endif
  psp_sdl_flip();
  ...
  while (! end_menu)
  {
        ...
        (new_pad == GP2X_CTRL_CIRCLE))
    {
      ...
      switch (cur_menu_id ) 
      {
        ...
        case MENU_LOAD_K7    : if (psp_main_menu_load(FMGR_FORMAT_K7)) {
                                 k7_device_loaded = 1;
        ...
        case MENU_LOAD_STATE : if (psp_main_menu_load(FMGR_FORMAT_STATE)) end_menu = 1;
                               old_pad = new_pad = 0;
        break;              
        case MENU_LOAD_DISK : if (psp_main_menu_load(FMGR_FORMAT_FD)) {
                                k7_device_loaded = 0;
                                cur_menu_id = MENU_COMMAND;
                              }
                              old_pad = new_pad = 0;

...
#define DELAY_KEY_REPEAT 80
  ...
  extern u32  gp2xCtrlGetTimeStamp();
  extern int  gp2xCtrlReadKeyboardSym();
  extern void gp2xPowerSetClockFrequency(int freq);
  extern int  gp2xCtrlConvertKeyboardSym( gp2xCtrlData* c);
  extern int  gp2xCtrlConvertFirstKeyboardSym( gp2xCtrlData* c);
